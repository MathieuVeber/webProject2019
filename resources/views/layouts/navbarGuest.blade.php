    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-info">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link disabled" href="#">Devis & Rendez-vous</a>
          </li>
        </ul>
        <span class="navbar-text">
          <a class="mr-sm-2" href="{{route('register')}}">S'inscrire</a>
        </span>
        <span class="navbar-item">
          <a class="btn btn-outline-light bg-info my-2 my-sm-0" href="{{route('login')}}">Se Connecter</a>
        </span>
      </div>
    </nav>

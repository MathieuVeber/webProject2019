    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-info">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="#sellingHome">Vente de Véhicule</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#contactHome">Contact</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('request', ['id'=>$user->id])}}">Devis & Rendez-vous</a>
          </li>
        </ul>
        <ul class='navbar-nav flex-row ml-md-auto d-none d-md-flex'>
          <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="{{route('profile', ['id'=>$user->id])}}">Mon Espace</a>
              <div class="dropdown-divider"></div>
              <form method='post' action='{{route("logout", ["id" => $user->id])}}'>
                @csrf
                <button class="btn btn-default dropdown-item" type='submit'>Déconnexion</button>
              </form>
            </div>
          </li>
        </ul>
